...
if __name__ == '__main__':
    create_tfrecord('../../images/number_10/train/', "../../tfrecord/number_10_train.tfrecords")
    create_tfrecord('../../images/number_10/test/', "../../tfrecord/number_10_test.tfrecords")
    create_tfrecord('../../images/number_10/validation/', "../../tfrecord/number_10_validation.tfrecords")